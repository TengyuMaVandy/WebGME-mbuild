...
from _Silane_ import Silane
from _CH2_ import CH2
...
if __name__ == "__main__":
    ...
    monomer_A = [CH2(), ("up", "down")]*3

    
    monomer_B = [Silane(), ("up", "down")]*3

    pattern = [cap_front, [monomer_A, monomer_B]*3, cap_end]
    poly = Copolymer(pattern=pattern, random=False)
    tempdir = poly.visualize(show_ports=False)
    print(tempdir)
