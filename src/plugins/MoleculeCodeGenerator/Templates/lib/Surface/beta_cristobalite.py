...
class Beta_Cristobalite(mb.Compound):
    ...
    """
    def __init__(self):
        super(Beta_Cristobalite, self).__init__()

        mb.load('beta_cristobalite.mol2', compound=self,
...
if __name__ == "__main__":
    single = Beta_Cristobalite()
    multiple = mb.TiledCompound(single, n_tiles=(1, 1, 1), name="tiled")
    tmpdir = multiple.visualize(show_ports=True)
    print(tmpdir)
