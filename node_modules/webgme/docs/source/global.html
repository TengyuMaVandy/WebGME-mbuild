...
<dl class="details">
    ...
    <h4 class="name" id="cleanUp"><span class="type-signature"></span>cleanUp<span class="signature">(options<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<span class="param-type">bool</span>
            ...
            <td class="description last">If true will do the deletion.</td>
        </tr>
...
<span class="param-type">bool</span>
            ...
            <td class="description last">If true will list all the projects the owner has rights too.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">User.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>daysAgo</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last">Time since last viewed (inclusive).</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">Maximum number of commits a deleted project can have..</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">Maximum number of branches a deleted project can have.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">Project names must match the regex.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_bin_clean_up.js.html">src/bin/clean_up.js</a>, <a href="src_bin_clean_up.js.html#line24">line 24</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getProjectJson"><span class="type-signature"></span>getProjectJson<span class="signature">(project, parameters, callback)</span><span class="type-signature"></span></h4>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Specifies which project tree should be serialized:
                <h6>Properties</h6>
...
<span class="param-type">string</span>
            ...
            <td class="description last">The hash of the tree root.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">The tree associated with the commitHash.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">The tree at the given tag.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">The tree at the given branch.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_common_storage_util.js.html">src/common/storage/util.js</a>, <a href="src_common_storage_util.js.html#line236">line 236</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="getStats"><span class="type-signature"></span>getStats<span class="signature">(options<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_bin_storage_stats.js.html">src/bin/storage_stats.js</a>, <a href="src_bin_storage_stats.js.html#line21">line 21</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="initialize"><span class="type-signature"></span>initialize<span class="signature">(middlewareOpts)</span><span class="type-signature"></span></h4>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Passed by the webgme server.
                <h6>Properties</h6>
...
<span class="param-type"><a href="global.html#GmeConfig">GmeConfig</a></span>
            ...
            <td class="description last">GME config parameters.</td>
        </tr>
...
<span class="param-type"><a href="global.html#GmeLogger">GmeLogger</a></span>
            ...
            <td class="description last">logger</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>ensureAuthenticated</code></td>
...
<span class="param-type">function</span>
            ...
            <td class="description last">Ensures the user is authenticated.</td>
        </tr>
...
<span class="param-type">function</span>
            ...
            <td class="description last">If authenticated retrieves the userId from the request.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Authorization module.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>safeStorage</code></td>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Accesses the storage and emits events (PROJECT_CREATED, COMMIT..).</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>workerManager</code></td>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Spawns and keeps track of "worker" sub-processes.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_server_middleware_ExampleRestRouter.js.html">src/server/middleware/ExampleRestRouter.js</a>, <a href="src_server_middleware_ExampleRestRouter.js.html#line30">line 30</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="insertProjectJson"><span class="type-signature"></span>insertProjectJson<span class="signature">(project, options<span class="signature-attributes">opt</span>, callback)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>commitMessage</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last">information about the insertion</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_common_storage_util.js.html">src/common/storage/util.js</a>, <a href="src_common_storage_util.js.html#line272">line 272</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="start"><span class="type-signature"></span>start<span class="signature">(callback)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_server_middleware_ExampleRestRouter.js.html">src/server/middleware/ExampleRestRouter.js</a>, <a href="src_server_middleware_ExampleRestRouter.js.html#line79">line 79</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_server_middleware_ExampleRestRouter.js.html">src/server/middleware/ExampleRestRouter.js</a>, <a href="src_server_middleware_ExampleRestRouter.js.html#line87">line 87</a>
    </li></ul></dd>
...
<h4 class="name" id="AccessRights">AccessRights</h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="src_server_middleware_auth_authorizerbase.js.html">src/server/middleware/auth/authorizerbase.js</a>, <a href="src_server_middleware_auth_authorizerbase.js.html#line14">line 14</a>
    </li></ul></dd>
...
<span class="param-type">string</span>
            ...
            <td class="description last">Message typically set in the constructor.</td>
        </tr>
...
<span class="param-type">stack</span>
            ...
            <td class="description last">Detailed stack trace.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="jsdocdefs.js.html">jsdocdefs.js</a>, <a href="jsdocdefs.js.html#line15">line 15</a>
    </li></ul></dd>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Add-on related settings.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Authentication related settings.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Bin script related settings.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Blob related settings.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Client related settings.</td>
        </tr>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last">Enables debug mode.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Executor related settings.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Mongo database related settings.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Plugin related settings.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Additional paths to for requirejs.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">REST related settings.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Seed related settings.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Server related settings.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Socket IO related settings.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Storage related settings.</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">Visualization related settings.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="jsdocdefs.js.html">jsdocdefs.js</a>, <a href="jsdocdefs.js.html#line23">line 23</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li><a href="https://github.com/webgme/webgme/tree/master/config/README.md">https://github.com/webgme/webgme/tree/master/config/README.md</a></li>
        </ul>
    </dd>
...
<h4 class="name" id="GmeLogger">GmeLogger</h4>
...
<span class="param-type">function</span>
            ...
            <td class="description last">Logs debug message.</td>
        </tr>
...
<span class="param-type">function</span>
            ...
            <td class="description last">Logs info message.</td>
        </tr>
...
<span class="param-type">function</span>
            ...
            <td class="description last">Logs warn message.</td>
        </tr>
...
<span class="param-type">function</span>
            ...
            <td class="description last">Logs error message.</td>
        </tr>
...
<span class="param-type">function</span>
            ...
            <td class="description last">Creates a new logger with the same settings
and a name that is an augmentation of this logger and the provided string. If the second argument is true -
the provided name will be used as is.</td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="jsdocdefs.js.html">jsdocdefs.js</a>, <a href="jsdocdefs.js.html#line45">line 45</a>
    </li></ul></dd>
...
<footer>
    Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.4.0</a> on Mon Oct 24 2016 15:10:43 GMT-0500 (CDT)
</footer>
