...
<head>
	...
	<title>WebGME Module: Storage</title>
...
<hr>
<dt class="name" id="~CommitHash">
    <h4 id="~CommitHash">CommitHash</h4>
...
<hr>
<dt class="name" id="~CommitObject">
    <h4 id="~CommitObject">CommitObject</h4>
...
<span class="param-type"><a href="global.html#number">number</a></span>
            ...
            <td class="description last"><p>When the commit object was created (new Date()).getTime().</p></td>
        </tr>
...
<hr>
<dt class="name" id="~CommitResult">
    <h4 id="~CommitResult">CommitResult</h4>
...
<hr>
<dt class="name" id="~PatchObject">
    <h4 id="~PatchObject">PatchObject</h4>
