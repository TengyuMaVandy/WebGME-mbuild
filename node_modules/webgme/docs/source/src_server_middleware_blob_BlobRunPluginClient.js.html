...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/server/middleware/blob/BlobRunPluginClient.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/server/middleware/blob/BlobRunPluginClient.js</h1>
