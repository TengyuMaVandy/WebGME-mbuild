...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/plugin/managerbase.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/plugin/managerbase.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>/*globals requirejs, define*/
