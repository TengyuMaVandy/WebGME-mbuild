...
<head>
	...
	<title>WebGME Class: BlobClient</title>
...
<hr>
<dt>
    <h4 class="name" id="BlobClient"><span class="type-signature"></span>new BlobClient(parameters)</h4>
...
<hr>
<dt>
    <h4 class="name" id="createArtifact"><span class="type-signature"></span>createArtifact(name)</h4>
...
<hr>
<dt>
    <h4 class="name" id="getArtifact"><span class="type-signature"></span>getArtifact(metadataHash [, callback])</h4>
...
<hr>
<dt>
    <h4 class="name" id="getDownloadURL"><span class="type-signature"></span>getDownloadURL(metadataHash [, subpath])</h4>
...
<hr>
<dt>
    <h4 class="name" id="getHumanSize"><span class="type-signature"></span>getHumanSize(bytes [, si])</h4>
...
<hr>
<dt>
    <h4 class="name" id="getMetadata"><span class="type-signature"></span>getMetadata(metadataHash [, callback])</h4>
...
<hr>
<dt>
    <h4 class="name" id="getObject"><span class="type-signature"></span>getObject(metadataHash [, callback] [, subpath])</h4>
...
<hr>
<dt>
    <h4 class="name" id="getObjectAsJSON"><span class="type-signature"></span>getObjectAsJSON(metadataHash [, callback])</h4>
...
<hr>
<dt>
    <h4 class="name" id="getObjectAsString"><span class="type-signature"></span>getObjectAsString(metadataHash [, callback])</h4>
...
<hr>
<dt>
    <h4 class="name" id="putFile"><span class="type-signature"></span>putFile(name, data [, callback])</h4>
...
<hr>
<dt>
    <h4 class="name" id="putFiles"><span class="type-signature"></span>putFiles(o [, callback])</h4>
...
<div class="param-desc">
    <p>On success the promise will be resolved with {object} <b>fileNamesToMetadataHashes</b>.<br>
On error the promise will be rejected with <a href="global.html#Error">Error</a> <b>error</b>.</p>
</div>
...
<hr>
<dt>
    <h4 class="name" id="saveAllArtifacts"><span class="type-signature"></span>saveAllArtifacts( [callback])</h4>
